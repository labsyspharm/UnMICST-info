...
class pspnet(nn.Module):
    ...
    def __init__(
        ...
        print("USING DROPOUT: {}".format(self.dropout_prob))
        ...
        #     in_channels=40, k_size=3, n_filters=64, padding=1, stride=2, bias=False
        # )

        ### 1-channel DNA segmentation ###
        # self.convbnrelu1_1 = conv2DBatchNormRelu(
        #     in_channels=1, k_size=3, n_filters=64, padding=1, stride=2, bias=False
        # )
        ...
        self.dropout = nn.Dropout2d(p=self.dropout_prob, inplace=False)
    ...
    # Main function when we feed an input image to the model
    def forward(self, x):
        inp_shape = x.shape[2:]
    ...
    def load_pretrained_model(self, model_path):
        ...
        # commented out for cycif
        # 33 classes
        # Ours only have 4 classes
