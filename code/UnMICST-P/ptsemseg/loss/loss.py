...
# size_average=False in first two methods to return loss per pixel 
# for weight calculation in the main script. 
...
def cross_entropy2d(input, target, weight=None, size_average=True):
    ...
    # Uncomment when including contour intersection and nuclei weights (comment out above)
    loss = F.cross_entropy(
