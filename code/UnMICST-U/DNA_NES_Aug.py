...
if __name__ == '__main__':
	...
	logPath = modelPath + '\\TFLogs'
	pmPath = modelPath + '\\TFProbMaps'

	imPath = scriptPath + '\\LPTCGSdapilaminRTAug64'
	validPath = scriptPath + '\\LPTCGSdapilaminRTAug64\\valid'
	testPath = scriptPath + '\\LPTCGSdapilaminRTAug64\\test'

	parser = argparse.ArgumentParser()
	parser.add_argument("function", help="whether to train/test/deploy")
	...
	if args.function == 'train':
		UNet2D.setup(64, 2, 3, 80, 2, 2, 3, 0, 0.03, 4, 32)  # 64 0.0001 4
		UNet2D.train(imPath, validPath, testPath, logPath, modelPath, pmPath, 3635, 133, 216, False, 20000, 0, 2)
	elif args.function == 'test':
		UNet2D.setup(64, 2, 3, 80, 2, 2, 3, 0, 0.03, 4, 32)  # 64 0.0001 4
		UNet2D.train(imPath, validPath, testPath, logPath, modelPath, pmPath, 3635, 133, 216, True, 0, 0, 2)
	else:
